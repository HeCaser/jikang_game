...
import kotlinx.android.synthetic.main.activity_ebook_record.*
 ...
 * 最好成绩会自动保存覆盖
 */
class EbookRecordActivity : BaseActivity() {

    companion object {
        fun start(ctx: Context, key: String,  speed: Int) {
            Intent(ctx, EbookRecordActivity::class.java).apply {
                putExtra("key", key)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ebook_record)
        initViewAndData()
        initListener()
    }
